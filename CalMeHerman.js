...
petik = '```'
fake = '©IBBBOTZ'//GANTI NAMA KAMU BEP
ban =[]
	...
	try {
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/sherlynn.jpg`)},"title": `©Bro Kenz Chanel`,"description": "IBBBotz", "currencyCode": "IDR","priceAmount1000": "99999999","retailerId": "IBBBotz","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
*Sewa bot?* Chat wa.me/6282239042679`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: 'IBBBotz', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTIVD dibawah!*`
       ...
       case 'othercmd':
               ...
               listmsg(from, `${ucapanWaktu}`,   `Subscribe https://youtube.com/c/Cyber211Xploit`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
...
*Chat Owner :* wa.me/6282239042679`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
case 'pricegtfo':
              gopeynya = 'https://i.ibb.co/kynNYTh/ganteng.jpg'
...
*ID Guild :* -
*Minat Join? Chat* wa.me/6282239042679
#WAVEFOREVER!`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
...
buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1},{buttonId:`${prefix}IBBbot`,buttonText:{displayText:'IBB BOT'},type:1}]
...
//------------------< Sticker/Tools >-------------------
       ...
       case 'dadu': // by Padel GANSTENGSSSZZ
              reply(mess.wait)
              dadu()
             .then(async (body) => {
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              dha.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *©IBB Botz* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
"sellerJid": "6282239042679@s.whatsapp.net",
...
"title": `IBB Bot ~ 404 ${vipi}`,
"description": `${virtex}`,
"currencyCode": "IDR",
"priceAmount1000": "99999999999999999999999999999999",
"productImageCount": 1
},
"businessOwnerJid": "6282239042679@s.whatsapp.net",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
              ...
              break
       case 'youtube': 
              reply(`*Subcribe YT Owner :*\n https://youtube.com/c/Cyber2112Xploit`)
              break
       case 'masukandata':
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              dha.sendMessage('6282239042679@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
         ...
         case 'pulsa':
             ...
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://www.instagram.com/kenzoxploit_/`)
             break
      case 'grupbot':
